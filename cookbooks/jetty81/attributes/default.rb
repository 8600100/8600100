...
when "centos","redhat","fedora"
  ...
  set["jetty"]["home"] = "/usr/share/jetty8"
  set["jetty"]["config_dir"] = "/etc/jetty8"
  set["jetty"]["log_dir"] = "/var/log/jetty8"
  set["jetty"]["tmp_dir"] = "/var/cache/jetty/data"
  set["jetty"]["context_dir"] = "/srv/jetty8/contexts"
  set["jetty"]["webapp_dir"] = "/srv/jetty8/webapps"
when "debian","ubuntu"
